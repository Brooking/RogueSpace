...
TEST_CASE("bresenham_withOrthogonal_shouldReturnRow", "[los]")
{
    ...
    REQUIRE(locations[0] == Location(1,2));
    REQUIRE(locations[1] == Location(1,3));
}
...
TEST_CASE("bresenham_withDiagonal_shouldReturnDiagonal", "[los]")
{
    ...
    // assert
    REQUIRE(locations.size() == 2);
    REQUIRE(locations[0] == Location(2,2));
    REQUIRE(locations[1] == Location(3,3));
}
...
TEST_CASE("bresenham_withOblique_shouldReturnOblique", "[los]")
{
    ...
    REQUIRE(locations[0] == Location(5,4));
    REQUIRE(locations[1] == Location(4,3));
    REQUIRE(locations[2] == Location(4,2));
    REQUIRE(locations[3] == Location(3,1));
    REQUIRE(locations[4] == Location(3,0));
}