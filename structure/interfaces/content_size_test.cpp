...
TEST_CASE("contentSize_with1large_shouldAllow", "[content_size]")
{
    // arrange
    std::shared_ptr<Tile> tile= std::make_shared<Tile>(/*floor*/nullptr, Location(0,0));
    std::shared_ptr<iThing> thing1 = std::make_shared<iThingMock>(TokenType::none, /*tile*/nullptr, ContentSize::large);
...
TEST_CASE("contentSize_with2small_shouldAllow", "[content_size]")
{
    ...
    std::shared_ptr<iThing> thing1 = std::make_shared<iThingMock>(TokenType::none, /*tile*/nullptr, ContentSize::small);
    tile->add(thing1);
    std::shared_ptr<iThing> thing2 = std::make_shared<iThingMock>(TokenType::none, /*tile*/nullptr, ContentSize::small);
...
TEST_CASE("contentSize_with1smalland1large_shouldAllow", "[content_size]")
{
    ...
    std::shared_ptr<iThing> thing1 = std::make_shared<iThingMock>(TokenType::none, /*tile*/nullptr, ContentSize::small);
    tile->add(thing1);
    std::shared_ptr<iThing> thing2 = std::make_shared<iThingMock>(TokenType::none, /*tile*/nullptr, ContentSize::large);
